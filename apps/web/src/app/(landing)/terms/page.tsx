  ...
  return (
    <main className="mx-auto mt-20 flex max-w-5xl flex-col gap-2 p-10">
      ...
      <p>
        ...
        relationship with peacocking.pro (the "Service") operated by Suryansh
        Anand ("us", "we", or "our").
      </p>
      <p>
      ...
      <div className="mt-6 flex flex-col gap-1">
        ...
        <p>
          ...
          cancel it. You may cancel your Subscription renewal either through
          your online account management page or by contacting Peacocking
        ...
        <p>
          ...
          Peacocking with accurate and complete billing information including
          ...
          you automatically authorize Peacocking to charge all Subscription fees
          incurred through your account to any such payment instruments.
        </p>
        <p>
          Should automatic billing fail to occur for any reason, Peacocking will
        ...
        <h3 className="text-lg font-bold">Fee Changes</h3>
        <p>
          Peacocking, in its sole discretion and at any time, may modify the
        ...
        <p>
          Peacocking will provide you with a reasonable prior notice of any
        ...
        <p>
          ...
          Peacocking on a case-by-case basis and granted in sole discretion of
          Peacocking. Incase, your refund request is approved, the refund will
          be processed within 5-7 working days to the original source of
          payment.
        </p>
        ...
        <h3 className="text-lg font-bold">Copyright Policy</h3>
        <p>
        ...
        <h3 className="text-lg font-bold">Links To Other Web Sites</h3>
        <p>
          Our Service may contain links to third-party web sites or services
          that are not owned or controlled by Peacocking.
        </p>
        <p>
          Peacocking has no control over, and assumes no responsibility for, the
          content, privacy policies, or practices of any third party web sites
          or services. You further acknowledge and agree that Peacocking shall
        ...
        <p>
          In no event shall Peacocking, nor its directors, employees, partners,
        ...
        <h3 className="text-lg font-bold" id="contact">
          Contact Us
        </h3>
        <p>
          ...
          <br />
          By Number:{" "}
          <a href="tel:+917032983019" className="text-blue-500 hover:underline">
            +91 7032983019
          </a>
          <br />
          Address: Tower 6, Lodha New Cuffe Parade Wadala, MUMBAI, MAHARASHTRA
          400037 India
        </p>
      </div>
    </main>
